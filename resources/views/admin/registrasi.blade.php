...
<html lang="en">
  ...
  <body>
    ...
    <!--Login area -->
    <div class="container">
    <form class="position-absolute top-50 start-50 translate-middle" action='{{ url('create_register') }}' method="post">
      @csrf
        <div class="bg-secondary p-5 rounded bg-opacity-75">
          <div class="mb-3">
            <label for="name" class="form-label">Name</label>
            <input type="text" class="form-control" value="{{ Session::get('name')}}" name="name" id="name" placeholder="Name">
          ...
          <div class="d-flex align-items-center justify-content-between mbt-4 mb-0">
            <span>
        ...
        <div class="d-flex justify-content-center mt-3 mb-5 pt-3 pb-5">
            <button id="submit" type="submit" class="btn px-5 btn-success">Register</button>
        </div>
      </form>
    </div>
